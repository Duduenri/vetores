...
function incluirTime() {
  ...
  console.log(`Tudo certo! '${nome}' cadastrado com sucesso na Divisão '${divisao}'`);
}
...
function listarTimes() {
  ...
  console.log("\nNome do Time............. Divisão..........");

  for (let i = 0; i < times.length; i++) {
    console.log(`${times[i].padEnd(25)} ${divisoes[i].toString().padEnd(15)}`);
  }
}
...
function alterarTime() {
  const nomeTime = prompt("Digite o nome do time para alterar: ");
...
function excluirTime() {
  const nomeTime = prompt("Digite o nome do time para excluir: ");
  const index = times.indexOf(nomeTime);
...
do {
  ...
  console.log("4. Pesquisar por Intervalo de Divisão");
  console.log("5. Alterar Time");
  console.log("6. Excluir Time");
